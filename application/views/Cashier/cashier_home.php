...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
        ...
        <li><a href="cashier_profile.php">PROFILE</a></li>
        <li><a href="cashier_scholarship.php">SCHOLARSHIPS</a></li>
        <li><a href="cashier_forum.php">FORUM</a></li>
        <li><a HREF="cashier_notification.php">NOTIFICATIONS</a></li>
                    ...
                    <div id="menu1" class="tab-pane fade clearfix">
                        <div class="click clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Dignissim Lacinia Nunc</a></h4>
                                    ...
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Curabitursodales Ligula In</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Sociosqu Ad Torquent</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="menu2" class="tab-pane fade clearfix">
                        <div class="click clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Sed Dignissim Lacinia</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Consectetur Adipiscing</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Integer Nec Odionec</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="click clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Curabitursodales Ligula </a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Nibh Elementum Imperdiet</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="menu4" class="tab-pane fade clearfix">
                        <div class="click clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Lorem Ipsum Dolor Sit</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Duis Sagittis Ipsum</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Tellus Sed Augue Semper</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="menu5" class="tab-pane fade clearfix">
                        <div class="click clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Vestibulum Lacinia Arcu</a></h4>
                                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odionec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
                                    </div>
                                    <div class="middle_6">
                                        <h4><a href="../scholarships.php">Curabitursodales Ligula</a></h4>
